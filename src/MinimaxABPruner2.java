 ...
 */
public class MinimaxABPruner2 {

    boolean testing = false;

    double evaluate(Board2 brd){
    ...
    Object[] getBestMove(Board2 brd, int depth, double alpha, double beta){
        ...
        while(moveList.size() > 0){
            Board2 newBrd = new Board2(brd.board, brd.nextPlayer, brd.prevPlayer);
