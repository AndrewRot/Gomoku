 ...
 * readMove: Read the move_file and add a move to the gameboard
...
public class GomokuAI {
    ...
    char[][] gameBoard = new char[15][15]; //2d array to keep track of the game board
    ...
    public GomokuAI(){
        ...
        this.moveFile = new File("move_file.go"); //maybe add .txt
    ...
    private void readMove()  throws IOException {
        ...
        while ((line = br.readLine()) != null) {    
            ...
            //determine whos move it was for the move, mark gameboard accordingly
            if(!groupName.equals(teamName))
                gameBoard[row] [col] = 'O'; //oppoenent mark
            else
                gameBoard[row] [col] = 'X'; //our mark
        }
